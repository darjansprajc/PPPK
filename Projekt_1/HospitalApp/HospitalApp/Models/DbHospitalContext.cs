...
public partial class DbHospitalContext : DbContext
{
    ...
    public virtual DbSet<CheckupDoctor> CheckupDoctors { get; set; }

    public virtual DbSet<CheckupImage> CheckupImages { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseNpgsql("Name=ConnectionStrings:HospitalDatabase");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Checkup>(entity =>
        {
            ...
            entity.HasOne(d => d.Type).WithMany(p => p.Checkups)
                .HasForeignKey(d => d.TypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("checkup_type_id_fkey");
        });

        modelBuilder.Entity<CheckupDoctor>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("checkup_doctor_pkey");

            entity.ToTable("checkup_doctor");
            ...
            entity.HasOne(d => d.Checkup).WithMany(p => p.CheckupDoctors)
                .HasForeignKey(d => d.CheckupId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("checkup_doctor_checkup_id_fkey");

            entity.HasOne(d => d.Doctor).WithMany(p => p.CheckupDoctors)
                .HasForeignKey(d => d.DoctorId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("checkup_doctor_doctor_id_fkey");
        });

        modelBuilder.Entity<CheckupImage>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("checkup_image_pkey");

            entity.ToTable("checkup_image");
            ...
            entity.HasOne(d => d.Checkup).WithMany(p => p.CheckupImages)
                .HasForeignKey(d => d.CheckupId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("checkup_image_checkup_id_fkey");
        });

        modelBuilder.Entity<CheckupType>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("checkup_type_pkey");

            entity.ToTable("checkup_type");
        ...
        {
            entity.HasKey(e => e.Id).HasName("medical_document_pkey");
            ...
            entity.Property(e => e.DoctorId).HasColumnName("doctor_id");
            entity.Property(e => e.EndOfSickness).HasColumnName("end_of_sickness");
            entity.Property(e => e.PatientId).HasColumnName("patient_id");
            entity.Property(e => e.Sickness).HasColumnName("sickness");
            entity.Property(e => e.StartOfSickness).HasColumnName("start_of_sickness");
            entity.Property(e => e.Title).HasColumnName("title");

            entity.HasOne(d => d.Doctor).WithMany(p => p.MedicalDocuments)
                .HasForeignKey(d => d.DoctorId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("medical_document_doctor_id_fkey");

            entity.HasOne(d => d.Patient).WithMany(p => p.MedicalDocuments)
                .HasForeignKey(d => d.PatientId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("medical_document_patient_id_fkey");
        });
        ...
        modelBuilder.Entity<Recipe>(entity =>
        {
            ...
            entity.Property(e => e.Description).HasColumnName("description");
            entity.Property(e => e.DoctorId).HasColumnName("doctor_id");
            entity.Property(e => e.EndOfMedication).HasColumnName("end_of_medication");
            entity.Property(e => e.Medicine).HasColumnName("medicine");
            entity.Property(e => e.PatientId).HasColumnName("patient_id");
            entity.Property(e => e.StartOfMedication).HasColumnName("start_of_medication");

            entity.HasOne(d => d.Doctor).WithMany(p => p.Recipes)
                .HasForeignKey(d => d.DoctorId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("recipe_doctor_id_fkey");

            entity.HasOne(d => d.Patient).WithMany(p => p.Recipes)
                .HasForeignKey(d => d.PatientId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("recipe_patient_id_fkey");
        });
